...
export function WhatsAppFloat() {
  ...
  const whatsappNumber = "241077663001"
  const message = "Bonjour Cabinet 2R Conseil, je souhaiterais obtenir des informations sur vos services."
          ...
          >
            ...
            <div className="bg-[#25D366] p-4 text-white flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="relative h-10 w-10 overflow-hidden rounded-full border-2 border-white/20 bg-white p-1">
                  <Image
                    src="/logo 2r.png"
                    alt="Cabinet 2R Conseil Logo"
                    fill
                    className="object-contain"
                  />
                </div>
                <div>
                  <p className="text-sm font-semibold">2R Conseil</p>
            ...
            <div className="p-6 bg-[#e5ddd5] dark:bg-zinc-900/50">
              <div className="relative rounded-lg rounded-tl-none bg-white p-3 text-sm text-zinc-800 shadow-sm dark:bg-zinc-800 dark:text-zinc-200">
                <p>
                  Bonjour ! 👋 <br />
                  Comment le Cabinet 2R Conseil peut-il vous accompagner aujourd&apos;hui ?
                </p>
                <span className="mt-1 block text-[10px] text-zinc-400">Maintenant</span>
