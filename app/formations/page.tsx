          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-1 gap-6">
              {categories.map((cat, i) => {
                const Icon = cat.icon
                return (
                  <RevealOnScroll key={cat.title} animation="reveal-right" delay={i * 100}>
                    <div className="bg-secondary/50 p-8 border border-border group hover:border-accent transition-colors">
      ...
      <section className="py-24 bg-secondary/30">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6">
            {[1, 2, 3].map((i) => (
              <RevealOnScroll key={i} animation="reveal-up" delay={i * 100}>
                <div className="bg-background border border-border p-8 flex flex-col md:flex-row md:items-center justify-between gap-8 group hover:shadow-xl transition-all">
